...
public class ClassFilePrinter
{
  ...
  public static void print(ClassFile cf, PrintWriter out) {
    ...
    out.println("major: " + cf.major + ", minor: " + cf.minor + " modifiers: " + 
        Integer.toHexString(cf.getAccessFlags()));
    out.println(Modifier.toString(mod) + " class " + cf
        .getName() + " extends " + cf.getSuperclass());
    ...
    for (FieldInfo finfo : fields) {
      ...
      out.println(Modifier.toString(AccessFlag.toModifier(acc)) + " " + finfo
          .getName() + "\t" + finfo
          .getDescriptor());
    ...
    for (MethodInfo minfo : methods) {
      ...
      out.println(Modifier.toString(AccessFlag.toModifier(acc)) + " " + minfo
          .getName() + "\t" + minfo
          .getDescriptor());
