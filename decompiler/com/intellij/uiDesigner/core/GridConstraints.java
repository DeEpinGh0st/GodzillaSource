  ...
  implements Cloneable
{
  ...
  public boolean equals(Object o) {
    ...
    if (this.myAnchor != gridConstraints.myAnchor) return false; 
    if (this.myColSpan != gridConstraints.myColSpan) return false; 
    if (this.myColumn != gridConstraints.myColumn) return false; 
    if (this.myFill != gridConstraints.myFill) return false; 
    if (this.myHSizePolicy != gridConstraints.myHSizePolicy) return false; 
    if (this.myRow != gridConstraints.myRow) return false; 
    if (this.myRowSpan != gridConstraints.myRowSpan) return false; 
    if (this.myVSizePolicy != gridConstraints.myVSizePolicy) return false; 
    if ((this.myMaximumSize != null) ? !this.myMaximumSize.equals(gridConstraints.myMaximumSize) : (gridConstraints.myMaximumSize != null)) return false; 
    if ((this.myMinimumSize != null) ? !this.myMinimumSize.equals(gridConstraints.myMinimumSize) : (gridConstraints.myMinimumSize != null)) return false; 
    if ((this.myPreferredSize != null) ? !this.myPreferredSize.equals(gridConstraints.myPreferredSize) : (gridConstraints.myPreferredSize != null)) return false; 
    if (this.myIndent != gridConstraints.myIndent) return false; 
    if (this.myUseParentLayout != gridConstraints.myUseParentLayout) return false;
