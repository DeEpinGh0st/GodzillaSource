  ...
  implements Serializable
{
    ...
    extends AbstractCollection<V>
  {
    ...
    class WrappedIterator
      ...
      WrappedIterator() {
        this.delegateIterator = AbstractMapBasedMultimap.iteratorOrListIterator(AbstractMapBasedMultimap.WrappedCollection.this.delegate);
      }
  ...
  private static <E> Iterator<E> iteratorOrListIterator(Collection<E> collection) {
    return (collection instanceof List) ? ((List<E>)collection)
  ...
  Spliterator<Map.Entry<K, V>> entrySpliterator() {
    return CollectSpliterators.flatMap(this.map
        .entrySet().spliterator(), keyToValueCollectionEntry -> { K key = (K)keyToValueCollectionEntry.getKey(); Collection<V> valueCollection = (Collection<V>)keyToValueCollectionEntry.getValue(); return CollectSpliterators.map(valueCollection.spliterator(), ()); }64, 
    ...
    extends Maps.ViewCachingAbstractMap<K, Collection<V>>
  {
      ...
      extends Maps.EntrySet<K, Collection<V>>
    {
      ...
      public Spliterator<Map.Entry<K, Collection<V>>> spliterator() {
        return CollectSpliterators.map(AbstractMapBasedMultimap.AsMap.this.submap.entrySet().spliterator(), AbstractMapBasedMultimap.AsMap.this::wrapEntry);
      }
