  ...
  implements RangeMap<K, V>, Serializable
{
    ...
    implements Serializable
  {
    ...
    Object createRangeMap() {
      ...
      for (UnmodifiableIterator<Map.Entry<Range<K>, V>> unmodifiableIterator = this.mapOfRanges.entrySet().iterator(); unmodifiableIterator.hasNext(); ) { Map.Entry<Range<K>, V> entry = unmodifiableIterator.next();
