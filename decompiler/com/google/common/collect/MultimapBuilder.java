      ...
      return new MultimapBuilder.ListMultimapBuilder<K0, Object>()
        {
          public <K extends K0, V> ListMultimap<K, V> build() {
            return Multimaps.newListMultimap(MultimapBuilder.MultimapBuilderWithKeys.this
      ...
      return new MultimapBuilder.ListMultimapBuilder<K0, Object>()
        {
          public <K extends K0, V> ListMultimap<K, V> build() {
            return Multimaps.newListMultimap(MultimapBuilder.MultimapBuilderWithKeys.this
                .createMap(), (Supplier)MultimapBuilder.LinkedListSupplier.instance());
          }
        };
    }
      ...
      return new MultimapBuilder.SetMultimapBuilder<K0, Object>()
        {
          public <K extends K0, V> SetMultimap<K, V> build() {
            return Multimaps.newSetMultimap(MultimapBuilder.MultimapBuilderWithKeys.this
      ...
      return new MultimapBuilder.SortedSetMultimapBuilder<K0, V0>()
        {
          public <K extends K0, V extends V0> SortedSetMultimap<K, V> build() {
            return Multimaps.newSortedSetMultimap(MultimapBuilder.MultimapBuilderWithKeys.this
      ...
      return new MultimapBuilder.SetMultimapBuilder<K0, V0>()
        {
          ...
          {
            Supplier<Set<V>> factory = (Supplier)new MultimapBuilder.EnumSetSupplier<>(valueClass);
