...
public final class CacheBuilderSpec
{
    ...
    implements ValueParser
  {
    ...
    public void parse(CacheBuilderSpec spec, String key, String value) {
      Preconditions.checkArgument((value != null && !value.isEmpty()), "value of key %s omitted", key); try {
        TimeUnit timeUnit;
        ...
        switch (lastChar) {
          ...
          default:
            throw new IllegalArgumentException(CacheBuilderSpec
                .format("key %s invalid format.  was %s, must end with one of [dDhHmMsS]", new Object[] { key, value }));
        } 
