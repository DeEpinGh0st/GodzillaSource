...
public final class Suppliers
{
    ...
    implements Supplier<T>, Serializable
  {
    ...
    public String toString() {
      return "Suppliers.memoize(" + (this.initialized ? ("<supplier that returned " + this.value + ">") : (String)this.delegate) + ")";
    }
  }
    ...
    implements Supplier<T>
  {
    ...
    public String toString() {
      ...
      return "Suppliers.memoize(" + ((delegate == null) ? ("<supplier that returned " + this.value + ">") : (String)delegate) + ")";
    }
  }
