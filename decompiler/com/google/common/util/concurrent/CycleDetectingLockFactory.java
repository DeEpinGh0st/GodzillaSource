...
public class CycleDetectingLockFactory
{
  ...
  private static Map<? extends Enum, LockGraphNode> getOrCreateNodes(Class<? extends Enum> clazz) {
    ...
    return (Map<? extends Enum, LockGraphNode>)MoreObjects.firstNonNull(existing, created);
  }
    ...
    extends CycleDetectingLockFactory
  {
    ...
    public ReentrantLock newReentrantLock(E rank, boolean fair) {
      return (this.policy == CycleDetectingLockFactory.Policies.DISABLED) ? new ReentrantLock(fair) : new CycleDetectingLockFactory.CycleDetectingReentrantLock(this.lockGraphNodes
    ...
    public ReentrantReadWriteLock newReentrantReadWriteLock(E rank, boolean fair) {
      return (this.policy == CycleDetectingLockFactory.Policies.DISABLED) ? new ReentrantReadWriteLock(fair) : new CycleDetectingLockFactory.CycleDetectingReentrantReadWriteLock(this.lockGraphNodes
