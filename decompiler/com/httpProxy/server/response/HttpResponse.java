...
public class HttpResponse
{
  ...
  public byte[] encode() {
    ...
    try {
      ...
      if (this.httpResponseHeader != null) {
        Iterator<String[]> headers = (Iterator)this.httpResponseHeader.getHeaders().iterator();
        String[] kv = null;
  ...
  public String toString() {
    return "HttpResponse{httpResponseStatus=" + this.httpResponseStatus + ", httpResponseHeader=" + this.httpResponseHeader + ", responseData=" + 

      
      Arrays.toString(this.responseData) + '}';
  }
}
