  ...
  extends JDialog
{
  ...
  public AppSeting() {
    super((Frame)MainActivity.getFrame(), "AppSeting", true);
    ...
    this.tabbedPane.addTab("全局代理", (Component)this.globalProxyPanel);
    this.tabbedPane.addTab("代理证书配置", (Component)this.httpsCertConfigPanel);
    this.tabbedPane.addTab("字体设置", this.setFontPanel);
    this.tabbedPane.addTab("核心配置", this.coreConfigPanel);
    this.tabbedPane.addTab("大文件配置", (Component)this.bigFilePanel);
  ...
  void initGlobalProxy() {
    ...
    this.globalProxyPanel.addX(new Component[] { this.globalProxyTypeLabel, this.globalProxyTypeComboBox });
    this.globalProxyPanel.addX(new Component[] { this.globalProxyHostLabel, this.globalProxyHostTextField });
    this.globalProxyPanel.addX(new Component[] { this.globalProxyPortLabel, this.globalProxyPortTextField });

    
    this.globalProxyPanel.addX(new Component[] { this.updateGlobalProxyButton });
  }
  ...
  void initHttpsCertConfig() {
    ...
    this.httpsCertConfigPanel.addX(new Component[] { this.httpsCertConfigExportButton, this.httpsCertConfigResetButton });
  }
  void initGloballHttpHeader() {
    ...
    splitPane.setTopComponent(new JScrollPane((Component)this.headerTextArea));
  ...
  public void initThemesPanel() {
    ...
    this.themesSplitPane.setTopComponent((Component)this.themesPanel);
  ...
  void initCoreConfigPanel() {
    ...
    this.isSuperLogCheckBox.addActionListener((ActionListener)new OpenC("isSuperLog", this.isSuperLogCheckBox));
    this.isAutoCloseShellCheckBox.addActionListener((ActionListener)new OpenC("isAutoCloseShell", this.isAutoCloseShellCheckBox));
  ...
  private void httpsCertConfigExportButtonClick(ActionEvent actionEvent) throws Exception {
    ...
    if (flag && selectdFile != null) {
      ...
      GOptionPane.showMessageDialog(this, String.format("Succes! cert >> %s", new Object[] { selectdFile.getCanonicalPath() }), "提示", 1);
    } else {
