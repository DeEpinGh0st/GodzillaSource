...
public class ChooseNewRetransmissionDialog extends JDialog {
  ...
  public ChooseNewRetransmissionDialog(Window parentWindow) { super(parentWindow);
    ...
    panel1.add(panel2, new GridConstraints(0, 0, 1, 1, 0, 3, 3, 3, null, null, null, 0, false));
    ...
    this.contentPane.add(panel3, new GridConstraints(0, 0, 1, 1, 0, 3, 3, 3, null, null, null, 0, false));
    this.listenAddressLabel = new JLabel();
    this.listenAddressLabel.setText("监听地址");
    panel3.add(this.listenAddressLabel, new GridConstraints(0, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.listenAddressTextField = new JTextField();
    this.listenAddressTextField.setText("127.0.0.1");
    panel3.add(this.listenAddressTextField, new GridConstraints(0, 1, 1, 1, 8, 1, 4, 0, null, new Dimension(150, -1), null, 0, false));
    this.listenPortLabel = new JLabel();
    this.listenPortLabel.setText("监听端口");
    panel3.add(this.listenPortLabel, new GridConstraints(1, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.listenPortTextField = new JTextField();
    this.listenPortTextField.setText("6666");
    panel3.add(this.listenPortTextField, new GridConstraints(1, 1, 1, 1, 8, 1, 4, 0, null, new Dimension(150, -1), null, 0, false));
    this.proxyTypeLabel = new JLabel();
    this.proxyTypeLabel.setText("代理类型");
    panel3.add(this.proxyTypeLabel, new GridConstraints(2, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    ...
    panel3.add(this.proxyTypeComboBox, new GridConstraints(2, 1, 1, 1, 8, 1, 2, 0, null, null, null, 0, false));
    this.targetAddressLabel = new JLabel();
    this.targetAddressLabel.setText("目标地址");
    panel3.add(this.targetAddressLabel, new GridConstraints(3, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.targetAddressTextField = new JTextField();
    this.targetAddressTextField.setText("8.8.8.8");
    panel3.add(this.targetAddressTextField, new GridConstraints(3, 1, 1, 1, 8, 1, 4, 0, null, new Dimension(150, -1), null, 0, false));
    this.targetPortLabel = new JLabel();
    this.targetPortLabel.setText("目标端口");
    panel3.add(this.targetPortLabel, new GridConstraints(4, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.targetPortTextField = new JTextField();
    this.targetPortTextField.setText("53");
    panel3.add(this.targetPortTextField, new GridConstraints(4, 1, 1, 1, 8, 1, 4, 0, null, new Dimension(150, -1), null, 0, false)); }
