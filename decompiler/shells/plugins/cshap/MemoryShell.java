...
public class MemoryShell implements Plugin {
  ...
  private void $$$setupUI$$$() {
    ...
    this.mainPanel.setLayout((LayoutManager)new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1, true, true));
    this.corePanel = new JPanel();
    this.corePanel.setLayout((LayoutManager)new GridLayoutManager(6, 2, new Insets(0, 0, 0, 0), -1, -1));
    this.mainPanel.add(this.corePanel, new GridConstraints(0, 0, 1, 1, 0, 0, 3, 3, null, null, null, 0, false));
    this.passwordLabel = new JLabel();
    this.passwordLabel.setText("密码:");
    this.corePanel.add(this.passwordLabel, new GridConstraints(0, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.passwordTextField = new JTextField();
    this.passwordTextField.setText("pass");
    this.corePanel.add(this.passwordTextField, new GridConstraints(0, 1, 1, 1, 8, 1, 4, 0, null, new Dimension(150, -1), null, 0, false));
    JLabel label1 = new JLabel();
    label1.setText("密钥:");
    this.corePanel.add(label1, new GridConstraints(1, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.keyTextField = new JTextField();
    this.keyTextField.setText("key");
    this.corePanel.add(this.keyTextField, new GridConstraints(1, 1, 1, 1, 0, 1, 4, 0, null, new Dimension(150, -1), null, 0, false));
    this.memoryShellTypeLabel = new JLabel();
    this.memoryShellTypeLabel.setText("Shell类型");
    this.corePanel.add(this.memoryShellTypeLabel, new GridConstraints(2, 0, 1, 1, 8, 0, 0, 0, null, null, null, 0, false));
    this.memoryShellTypeComboBox = new JComboBox();
    this.corePanel.add(this.memoryShellTypeComboBox, new GridConstraints(2, 1, 1, 1, 8, 1, 2, 0, null, null, null, 0, false));
    this.addMemoryShellButton = new JButton();
    this.addMemoryShellButton.setText("添加内存Shell");
    this.corePanel.add(this.addMemoryShellButton, new GridConstraints(5, 0, 1, 2, 0, 1, 3, 0, null, null, null, 0, false));
    this.bypassFriendlyUrlRouteButton = new JButton();
    this.bypassFriendlyUrlRouteButton.setText("bypassFriendlyUrlRoute");
    this.corePanel.add(this.bypassFriendlyUrlRouteButton, new GridConstraints(3, 0, 1, 2, 0, 1, 3, 0, null, null, null, 0, false));
    this.bypassPrecompiledAppButton = new JButton();
    this.bypassPrecompiledAppButton.setText("bypassPrecompiledApp");
    this.corePanel.add(this.bypassPrecompiledAppButton, new GridConstraints(4, 0, 1, 2, 0, 1, 3, 0, null, null, null, 0, false));
      ...
      GOptionPane.showMessageDialog(UiFunction.getParentWindow(this.mainPanel), "插件加载失败");
    }  } public JComponent $$$getRootComponent$$$() { return this.mainPanel; }
