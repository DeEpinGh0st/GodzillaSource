  ...
  implements DatePrinter, Serializable
{
  ...
  protected List<Rule> parsePattern() {
    ...
    for (int i = 0; i < length; i++) {
      Rule rule; String sub; indexRef[0] = i;
      ...
      switch (c) {
        ...
        case 'y':
          if (tokenLen == 2) {
            rule = TwoDigitYearField.INSTANCE; break;
          } 
        ...
        case 'M':
          if (tokenLen >= 4) {
            rule = new TextField(2, months); break;
          }  if (tokenLen == 3) {
            rule = new TextField(2, shortMonths); break;
          }  if (tokenLen == 2) {
            rule = TwoDigitMonthField.INSTANCE; break;
          } 
        ...
        case 'z':
          if (tokenLen >= 4) {
            rule = new TimeZoneNameRule(this.mTimeZone, this.mLocale, 1); break;
          } 
        ...
        case 'Z':
          if (tokenLen == 1) {
            rule = TimeZoneNumberRule.INSTANCE_NO_COLON; break;
          }  if (tokenLen == 2) {
            rule = TimeZoneNumberRule.INSTANCE_ISO_8601; break;
          } 
        ...
        case '\'':
          ...
          if (sub.length() == 1) {
            rule = new CharacterLiteral(sub.charAt(0)); break;
          } 
