  ...
  extends ClassEmitter
{
  ...
  public BeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
    ...
    begin_class(52, 1, className, BEAN_MAP, null, "<generated>");
    ...
    Map<Object, Object> allProps = new HashMap<Object, Object>();
    ...
    if (require != 0) {
      for (Iterator<String> it = allProps.keySet().iterator(); it.hasNext(); ) {
        String name = it.next();
        if (((require & 0x1) != 0 && !getters.containsKey(name)) || ((require & 0x2) != 0 && 
  ...
  private String[] getNames(Map propertyMap) {
    return (String[])propertyMap.keySet().toArray((Object[])new String[propertyMap.size()]);
  }
  ...
  private void generateKeySet(String[] allNames) {
    ...
    e.dup();
    EmitUtils.push_array(e, (Object[])allNames);
