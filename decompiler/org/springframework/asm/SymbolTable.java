...
final class SymbolTable
{
  ...
  SymbolTable(ClassWriter classWriter, ClassReader classReader) {
    ...
    while (itemIndex < this.constantPoolCount) {
      int nameAndTypeItemOffset, memberRefItemOffset, itemOffset = classReader.getItem(itemIndex);
      ...
      switch (itemTag) {
        ...
        case 11:
          ...
          addConstantMemberReference(itemIndex, itemTag, classReader
              ...
              .readClass(itemOffset, charBuffer), classReader
              .readUTF8(nameAndTypeItemOffset, charBuffer), classReader
        ...
        case 4:
          ...
          break;
        case 12:
          addConstantNameAndType(itemIndex, classReader
              
              .readUTF8(itemOffset, charBuffer), classReader
        ...
        case 15:
          ...
          addConstantMethodHandle(itemIndex, classReader
              
              .readByte(itemOffset), classReader
              .readClass(memberRefItemOffset, charBuffer), classReader
              .readUTF8(nameAndTypeItemOffset, charBuffer), classReader
              .readUTF8(nameAndTypeItemOffset + 2, charBuffer));
          break;
        case 17:
        case 18:
          ...
          nameAndTypeItemOffset = classReader.getItem(classReader.readUnsignedShort(itemOffset + 2));
          addConstantDynamicOrInvokeDynamicReference(itemTag, itemIndex, classReader

              
              .readUTF8(nameAndTypeItemOffset, charBuffer), classReader
              .readUTF8(nameAndTypeItemOffset + 2, charBuffer), classReader
              .readUnsignedShort(itemOffset));
          break;
        case 7:
        case 8:
        case 16:
        case 19:
        case 20:
          addConstantUtf8Reference(itemIndex, itemTag, classReader
              .readUTF8(itemOffset, charBuffer));
          break;
        default:
          throw new IllegalArgumentException();
      } 
      itemIndex += (itemTag == 5 || itemTag == 6) ? 2 : 1;
    } 
  ...
  private void copyBootstrapMethods(ClassReader classReader, char[] charBuffer) {
    ...
    if (this.bootstrapMethodCount > 0) {
      ...
      for (int j = 0; j < this.bootstrapMethodCount; j++) {
        ...
        add(new Entry(j, 64, offset, hashCode & Integer.MAX_VALUE));
      } 
    } 
  }
  ...
  int addMergedType(int typeTableIndex1, int typeTableIndex2) {
    long data = (typeTableIndex1 < typeTableIndex2) ? (typeTableIndex1 | typeTableIndex2 << 32L) : (typeTableIndex2 | typeTableIndex1 << 32L);
  ...
  private static int hash(int tag, long value) {
    return Integer.MAX_VALUE & tag + (int)value + (int)(value >>> 32L);
  }
