...
public final class Type
{
  ...
  public static Type getReturnType(String methodDescriptor) {
    return getTypeInternal(methodDescriptor, 
        getReturnTypeOffset(methodDescriptor), methodDescriptor.length());
  }
  ...
  public boolean equals(Object object) {
    ...
    if (((this.sort == 12) ? true : this.sort) != ((other.sort == 12) ? true : other.sort)) {
      return false;
    }
