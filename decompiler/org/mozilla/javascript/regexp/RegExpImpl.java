...
public class RegExpImpl implements RegExpProxy {
  ...
  public Scriptable wrapRegExp(Context cx, Scriptable scope, Object compiled) {
    return (Scriptable)new NativeRegExp(scope, (RECompiled)compiled); } public Object action(Context cx, Scriptable scope, Scriptable thisObj, Object[] args, int actionType) { NativeRegExp re; boolean useRE; Object rval; NativeRegExp nativeRegExp1;
    String search;
    Object arg1;
    String repstr;
    Function lambda;
    ...
    switch (actionType) {
      ...
      case 1:
        re = createRegExp(cx, scope, args, 1, false);
        rval = matchOrReplace(cx, scope, thisObj, args, this, data, re);
      ...
      case 2:
        useRE = ((args.length > 0 && args[0] instanceof NativeRegExp) || args.length > 2);
        
        nativeRegExp1 = null;
        search = null;
        if (useRE) {
          nativeRegExp1 = createRegExp(cx, scope, args, 2, true);
        } else {
        ...
        if (useRE) {
          val = matchOrReplace(cx, scope, thisObj, args, this, data, nativeRegExp1);
        } else {
  ...
  private static NativeRegExp createRegExp(Context cx, Scriptable scope, Object[] args, int optarg, boolean forceFlat) {
    ...
    if (args.length == 0 || args[0] == Undefined.instance) {
      ...
      String opt, src = ScriptRuntime.toString(args[0]);
