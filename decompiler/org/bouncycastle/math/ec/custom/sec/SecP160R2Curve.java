...
public class SecP160R2Curve extends ECCurve.AbstractFp {
  ...
  protected ECCurve cloneCurve() {
    return (ECCurve)new SecP160R2Curve();
  }
  ...
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, boolean paramBoolean) {
    return (ECPoint)new SecP160R2Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2, paramBoolean);
  }
  ...
  protected ECPoint createRawPoint(ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement, boolean paramBoolean) {
    return (ECPoint)new SecP160R2Point((ECCurve)this, paramECFieldElement1, paramECFieldElement2, paramArrayOfECFieldElement, paramBoolean);
  }
