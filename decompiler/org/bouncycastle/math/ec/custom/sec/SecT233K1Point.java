...
public class SecT233K1Point extends ECPoint.AbstractF2m {
  public SecT233K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    this(paramECCurve, paramECFieldElement1, paramECFieldElement2, false);
  }
  
  public SecT233K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, boolean paramBoolean) {
  ...
  SecT233K1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement, boolean paramBoolean) {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new SecT233K1Point(eCCurve, eCFieldElement13, eCCurve.getB(), this.withCompression); 
    ...
    return (ECPoint)new SecT233K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 }, this.withCompression);
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement5.isZero())
      return (ECPoint)new SecT233K1Point(eCCurve, eCFieldElement5, eCCurve.getB(), this.withCompression); 
    ...
    return (ECPoint)new SecT233K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[] { eCFieldElement7 }, this.withCompression);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecT233K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 }, this.withCompression);
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new SecT233K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 }, this.withCompression);
  }
}
