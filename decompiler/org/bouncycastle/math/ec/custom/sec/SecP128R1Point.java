...
public class SecP128R1Point extends ECPoint.AbstractFp {
  public SecP128R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    this(paramECCurve, paramECFieldElement1, paramECFieldElement2, false);
  }
  
  public SecP128R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, boolean paramBoolean) {
  ...
  SecP128R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement, boolean paramBoolean) {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    ECFieldElement[] arrayOfECFieldElement = { secP128R1FieldElement9 };
    return (ECPoint)new SecP128R1Point(eCCurve, secP128R1FieldElement7, secP128R1FieldElement8, arrayOfECFieldElement, this.withCompression);
  }
  ...
  public ECPoint twice() {
    ...
    return (ECPoint)new SecP128R1Point(eCCurve, secP128R1FieldElement4, secP128R1FieldElement5, new ECFieldElement[] { secP128R1FieldElement6 }, this.withCompression);
  }
  ...
  public ECPoint negate() {
    return (ECPoint)(isInfinity() ? this : new SecP128R1Point(this.curve, this.x, this.y.negate(), this.zs, this.withCompression));
  }
}
