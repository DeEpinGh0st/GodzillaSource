...
public class SecT113R2Point extends ECPoint.AbstractF2m {
  public SecT113R2Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    this(paramECCurve, paramECFieldElement1, paramECFieldElement2, false);
  }
  
  public SecT113R2Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, boolean paramBoolean) {
  ...
  SecT113R2Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement, boolean paramBoolean) {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new SecT113R2Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt(), this.withCompression); 
    ...
    return (ECPoint)new SecT113R2Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 }, this.withCompression);
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement8.isZero())
      return (ECPoint)new SecT113R2Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt(), this.withCompression); 
    ...
    return (ECPoint)new SecT113R2Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[] { eCFieldElement10 }, this.withCompression);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return (ECPoint)new SecT113R2Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 }, this.withCompression);
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new SecT113R2Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 }, this.withCompression);
  }
}
