...
public class SecT409R1Point extends ECPoint.AbstractF2m {
  public SecT409R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2) {
    this(paramECCurve, paramECFieldElement1, paramECFieldElement2, false);
  }
  
  public SecT409R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, boolean paramBoolean) {
  ...
  SecT409R1Point(ECCurve paramECCurve, ECFieldElement paramECFieldElement1, ECFieldElement paramECFieldElement2, ECFieldElement[] paramArrayOfECFieldElement, boolean paramBoolean) {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt(), this.withCompression); 
    ...
    return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 }, this.withCompression);
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement6.isZero())
      return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt(), this.withCompression); 
    ...
    return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 }, this.withCompression);
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (eCFieldElement12.isZero())
      return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt(), this.withCompression); 
    ...
    return (ECPoint)new SecT409R1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 }, this.withCompression);
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return (ECPoint)new SecT409R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 }, this.withCompression);
  }
}
