...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
  ...
  private void checkPermittedDN(X500Name paramX500Name) throws NameConstraintValidatorException {
    checkPermittedDN(this.permittedSubtreesDN, ASN1Sequence.getInstance(paramX500Name.toASN1Primitive()));
  }
  
  private void checkExcludedDN(X500Name paramX500Name) throws NameConstraintValidatorException {
