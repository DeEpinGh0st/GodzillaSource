...
public class XMSSMTPrivateKey extends ASN1Object {
  ...
  public XMSSMTPrivateKey(int paramInt, byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, byte[] paramArrayOfbyte3, byte[] paramArrayOfbyte4, byte[] paramArrayOfbyte5) {
    this.index = paramInt;
