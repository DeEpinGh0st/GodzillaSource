...
public final class TnepresEngine extends SerpentEngineBase {
  ...
  protected void encryptBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) {
    this.X3 = Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1);
    this.X2 = Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 4);
    this.X1 = Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 8);
    this.X0 = Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 12);
    ...
    Pack.intToBigEndian(this.wKey[131] ^ this.X3, paramArrayOfbyte2, paramInt2);
    Pack.intToBigEndian(this.wKey[130] ^ this.X2, paramArrayOfbyte2, paramInt2 + 4);
    Pack.intToBigEndian(this.wKey[129] ^ this.X1, paramArrayOfbyte2, paramInt2 + 8);
    Pack.intToBigEndian(this.wKey[128] ^ this.X0, paramArrayOfbyte2, paramInt2 + 12);
  }
  
  protected void decryptBlock(byte[] paramArrayOfbyte1, int paramInt1, byte[] paramArrayOfbyte2, int paramInt2) {
    this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1);
    this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 4);
    this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 8);
    this.X0 = this.wKey[128] ^ Pack.bigEndianToInt(paramArrayOfbyte1, paramInt1 + 12);
    ...
    inverseLT();
    ib0(this.X0, this.X1, this.X2, this.X3);
    Pack.intToBigEndian(this.X3 ^ this.wKey[3], paramArrayOfbyte2, paramInt2);
    Pack.intToBigEndian(this.X2 ^ this.wKey[2], paramArrayOfbyte2, paramInt2 + 4);
    Pack.intToBigEndian(this.X1 ^ this.wKey[1], paramArrayOfbyte2, paramInt2 + 8);
    Pack.intToBigEndian(this.X0 ^ this.wKey[0], paramArrayOfbyte2, paramInt2 + 12);
  }
}
