...
public class IESCipher extends CipherSpi {
  ...
  public static class IESwithAESCBC extends IESCipher {
    public IESwithAESCBC() {
      super(new IESEngine((BasicAgreement)new DHBasicAgreement(), (DerivationFunction)new KDF2BytesGenerator(DigestFactory.createSHA1()), (Mac)new HMac(DigestFactory.createSHA1()), (BufferedBlockCipher)new PaddedBufferedBlockCipher((BlockCipher)new CBCBlockCipher((BlockCipher)new AESEngine()))), 16);
    }
  }
  
  public static class IESwithDESedeCBC extends IESCipher {
    public IESwithDESedeCBC() {
      super(new IESEngine((BasicAgreement)new DHBasicAgreement(), (DerivationFunction)new KDF2BytesGenerator(DigestFactory.createSHA1()), (Mac)new HMac(DigestFactory.createSHA1()), (BufferedBlockCipher)new PaddedBufferedBlockCipher((BlockCipher)new CBCBlockCipher((BlockCipher)new DESedeEngine()))), 8);
    }
  }
}
