...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
  ...
  public X509CertificateObject(JcaJceHelper paramJcaJceHelper, Certificate paramCertificate) throws CertificateParsingException {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (paramObject instanceof X509CertificateObject) {
      ...
      return (this.hashValueSet && x509CertificateObject.hashValueSet && this.hashValue != x509CertificateObject.hashValue) ? false : this.c.equals(x509CertificateObject.c);
    } 
  ...
  public final void verify(PublicKey paramPublicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
    ...
    try {
      signature = this.bcHelper.createSignature(str);
    } catch (Exception exception) {
